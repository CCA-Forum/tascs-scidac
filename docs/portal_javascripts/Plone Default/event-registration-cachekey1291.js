...
// http://tascs-scidac.org/portal_javascripts/event-registration.js?original=1
...
// http://tascs-scidac.org/portal_javascripts/register_function.js?original=1
...
/* - cssQuery.js - */
// http://tascs-scidac.org/portal_javascripts/cssQuery.js?original=1
...
/* - sarissa.js - */
// http://tascs-scidac.org/portal_javascripts/sarissa.js?original=1
...
// http://tascs-scidac.org/portal_javascripts/plone_javascript_variables.js?original=1
var portal_url='http://tascs-scidac.org';var form_modified_message='Your form has not been saved. All changes you have made will be lost.';var form_resubmit_message='You already clicked the submit button. Do you really want to submit this form again?';var external_links_open_new_window='false';

/* - nodeutilities.js - */
// http://tascs-scidac.org/portal_javascripts/nodeutilities.js?original=1
...
/* - cookie_functions.js - */
// http://tascs-scidac.org/portal_javascripts/cookie_functions.js?original=1
...
/* - livesearch.js - */
// http://tascs-scidac.org/portal_javascripts/livesearch.js?original=1
...
/* - select_all.js - */
// http://tascs-scidac.org/portal_javascripts/select_all.js?original=1
...
/* - dragdropreorder.js - */
// http://tascs-scidac.org/portal_javascripts/dragdropreorder.js?original=1
var ploneDnDReorder={}
...
// http://tascs-scidac.org/portal_javascripts/collapsiblesections.js?original=1
...
/* - form_tabbing.js - */
// http://tascs-scidac.org/portal_javascripts/form_tabbing.js?original=1
...
/* - input-label.js - */
// http://tascs-scidac.org/portal_javascripts/input-label.js?original=1
...
// http://tascs-scidac.org/portal_javascripts/highlightsearchterms.js?original=1
...
/* - se-highlight.js - */
// http://tascs-scidac.org/portal_javascripts/se-highlight.js?original=1
...
// http://tascs-scidac.org/portal_javascripts/first_input_focus.js?original=1
...
/* - accessibility.js - */
// http://tascs-scidac.org/portal_javascripts/accessibility.js?original=1
...
/* - styleswitcher.js - */
// http://tascs-scidac.org/portal_javascripts/styleswitcher.js?original=1
function setActiveStyleSheet(title,reset){if(!W3CDOM){return false};var i,a,main;for(i=0;(a=document.getElementsByTagName("link")[i]);i++){if(a.getAttribute("rel").indexOf("style")!=-1&&a.getAttribute("title")){a.disabled=true;if(a.getAttribute("title")==title){a.disabled=false}}}
if(reset==1){createCookie("wstyle",title,365)}};
function setStyle(){var style=readCookie("wstyle");if(style!=null){setActiveStyleSheet(style,0)}};registerPloneFunction(setStyle);

/* - toc.js - */
// http://tascs-scidac.org/portal_javascripts/toc.js?original=1
